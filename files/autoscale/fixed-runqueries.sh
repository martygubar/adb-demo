...
# 		For example;
#		ln -s /usr/bin/sqlplus fixed-sqlpluslow
#		ln -s /usr/bin/sqlplus fixed-sqlplusmedium
#		ln -s /usr/bin/sqlplus fixed-sqlplushigh
