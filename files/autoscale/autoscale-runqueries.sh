...
# 		For example;
#		ln -s /usr/bin/sqlplus autoscale-sqlpluslow
#		ln -s /usr/bin/sqlplus autoscale-sqlplusmedium
#		ln -s /usr/bin/sqlplus autoscale-sqlplushigh
